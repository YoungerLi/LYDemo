...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < nameArray.count; i++) {
        UIButton *button = [UIButton buttonWithFrame:CGRectMake(50, 70+i*40, kSCREEN_WIDTH-100, 30) backgroundColor:[UIColor redColor] title:nameArray[i] addTarget:self action:@selector(click:)];
        button.tag = 1 + i;
